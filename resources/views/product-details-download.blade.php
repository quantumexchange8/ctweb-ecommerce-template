                ...
                <div class="col-xxl-7 col-xl-7 col-lg-7">
                    <div class="product__details-wrapper">
                        <div class="product__details">
                            ...
                            <div class="product__details-download d-sm-flex align-items-end mb-25">
                                <div class="product__details-download-input">
                                    <span>Links</span>
                                    <input class="m-check-input" type="checkbox" id="m-wp">
                                    <label class="m-check-label" for="m-wp"> 32" CHG70 Gaming Monitor with Quantum Dot + $266.00 </label>
                                </div>
                                <div class="product__details-download-btn">
                                    <a href="#">Download</a>
                                </div>
                            </div>
